...
import 'package:vendor_app/widgets/buttons/checkbox.dart';
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == true && data['data'] != null) {
          setState(() {
            ...
            storeLogoUrl =
                (storeData['logo'] != null && storeData['logo'].isNotEmpty)
                                ...
                                storeTypes.map((type) {
                                  return Expanded(
                                    child: CustomCheckbox(
                                      label:
                                          type["name"], // Dynamically set label
                                      value:
