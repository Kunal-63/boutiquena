...
import 'package:boutiquena_vendor/models/product.dart';
import 'package:boutiquena_vendor/utils/custom_network_image.dart';
import 'package:boutiquena_vendor/utils/size_config.dart';
import 'package:boutiquena_vendor/widgets/cards/discount.dart';
import 'package:boutiquena_vendor/widgets/cards/product_card.dart';
import 'package:boutiquena_vendor/widgets/headers/main_screen_appbar.dart';
                            ...
                            series: <CircularSeries>[
                              DoughnutSeries<Map<String, dynamic>, String>(
                                ...
                                pointColorMapper: (data, index) => index == 0
                                    ...
                                    : const Color.fromRGBO(248, 159, 146, 1),
                                innerRadius: '70%',
                              ),
                            ],
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              SizedBox(
                height:
                    150 * SizeConfig.heightScale, // Fixed height for PageView
                child: PageView.builder(
