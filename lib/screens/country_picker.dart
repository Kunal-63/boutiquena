...
class _CountryPickerScreenState extends State<CountryPickerScreen> {
  ...
  void _initializeCountries() {
    _countries = [
      ...
      CountryCode(
          code: "BJ", name: "Benin", dialCode: "+229", flagUri: "flags/bj.png"),
      CountryCode(
          code: "BT",
          name: "Bhutan",
          dialCode: "+975",
      ...
      CountryCode(
          code: "BR", name: "Brazil", dialCode: "+55", flagUri: "flags/br.png"),
      CountryCode(
          code: "BG",
          name: "Bulgaria",
          dialCode: "+359",
      ...
      CountryCode(
          code: "CA", name: "Canada", dialCode: "+1", flagUri: "flags/ca.png"),
      CountryCode(
          code: "CL", name: "Chile", dialCode: "+56", flagUri: "flags/cl.png"),
      CountryCode(
          code: "CN", name: "China", dialCode: "+86", flagUri: "flags/cn.png"),
      CountryCode(
          code: "CO",
          name: "Colombia",
          dialCode: "+57",
      ...
      CountryCode(
          code: "CU", name: "Cuba", dialCode: "+53", flagUri: "flags/cu.png"),
      CountryCode(
          code: "CY",
          name: "Cyprus",
          dialCode: "+357",
      ...
      CountryCode(
          code: "EG", name: "Egypt", dialCode: "+20", flagUri: "flags/eg.png"),
      CountryCode(
          code: "FI",
          name: "Finland",
          dialCode: "+358",
      ...
      CountryCode(
          code: "FR", name: "France", dialCode: "+33", flagUri: "flags/fr.png"),
      CountryCode(
          code: "DE",
          name: "Germany",
          dialCode: "+49",
      ...
      CountryCode(
          code: "GR", name: "Greece", dialCode: "+30", flagUri: "flags/gr.png"),
      CountryCode(
          code: "IN", name: "India", dialCode: "+91", flagUri: "flags/in.png"),
      CountryCode(
          code: "ID",
          name: "Indonesia",
          dialCode: "+62",
      ...
      CountryCode(
          code: "IR", name: "Iran", dialCode: "+98", flagUri: "flags/ir.png"),
      CountryCode(
          code: "IQ", name: "Iraq", dialCode: "+964", flagUri: "flags/iq.png"),
      CountryCode(
          code: "IE",
          name: "Ireland",
          dialCode: "+353",
      ...
      CountryCode(
          code: "IT", name: "Italy", dialCode: "+39", flagUri: "flags/it.png"),
      CountryCode(
          code: "JP", name: "Japan", dialCode: "+81", flagUri: "flags/jp.png"),
      CountryCode(
          code: "KE", name: "Kenya", dialCode: "+254", flagUri: "flags/ke.png"),
      CountryCode(
          code: "KW",
          name: "Kuwait",
          dialCode: "+965",
      ...
      CountryCode(
          code: "MX", name: "Mexico", dialCode: "+52", flagUri: "flags/mx.png"),
      CountryCode(
          code: "MA",
          name: "Morocco",
          dialCode: "+212",
      ...
      CountryCode(
          code: "NO", name: "Norway", dialCode: "+47", flagUri: "flags/no.png"),
      CountryCode(
          code: "PK",
          name: "Pakistan",
          dialCode: "+92",
      ...
      CountryCode(
          code: "PL", name: "Poland", dialCode: "+48", flagUri: "flags/pl.png"),
      CountryCode(
          code: "PT",
          name: "Portugal",
          dialCode: "+351",
      ...
      CountryCode(
          code: "RU", name: "Russia", dialCode: "+7", flagUri: "flags/ru.png"),
      CountryCode(
          code: "SA",
          name: "Saudi Arabia",
          dialCode: "+966",
      ...
      CountryCode(
          code: "ES", name: "Spain", dialCode: "+34", flagUri: "flags/es.png"),
      CountryCode(
          code: "LK",
          name: "Sri Lanka",
          dialCode: "+94",
      ...
      CountryCode(
          code: "SE", name: "Sweden", dialCode: "+46", flagUri: "flags/se.png"),
      CountryCode(
          code: "CH",
          name: "Switzerland",
          dialCode: "+41",
      ...
      CountryCode(
          code: "TR", name: "Turkey", dialCode: "+90", flagUri: "flags/tr.png"),
      CountryCode(
          code: "AE",
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        contentPadding: const EdgeInsets.symmetric(
                            horizontal: 10, vertical: 0), // Less padding
                        leading: ClipRRect(
