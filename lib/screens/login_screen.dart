...
import 'package:boutiquena_vendor/widgets/popups/otp_popup.dart';
    ...
    if (response["status"] == false) {
      ...
      showDialog(
        ...
        builder: (context) => CustomPopUp(
          ...
          title: message == 'Your account is not approved by admin!'
              ? 'Error'
              : '',
          message: message,
          imagePath: message == 'Your account is not approved by admin!'
