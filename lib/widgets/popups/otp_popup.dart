      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Enter OTP', style: AppTextStyles.loginHeadingStyle()),
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Text(
                    'Resend OTP',
                    style: AppTextStyles.greySubHeadingStyle(
                      color: _disabledResendOTP ? Colors.grey : Colors.black,
                    ),
                  ),
                ),
              ],
...
class OTPInputWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 10.0 * SizeConfig.widthScale),
      child: PinCodeTextField(
        ...
        textStyle: AppTextStyles.blackHeadingStyle().copyWith(
          fontSize: 14 * SizeConfig.widthScale,
        ),
        pinTheme: PinTheme(
          shape: PinCodeFieldShape.box,
          borderRadius: BorderRadius.circular(3),
          fieldHeight: 45 * SizeConfig.widthScale,
          fieldWidth: 35 * SizeConfig.widthScale,
