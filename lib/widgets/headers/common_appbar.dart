          ...
          children: [
            ...
            Text(
              ...
              style: AppTextStyles.whitew400Outfit()
                  .copyWith(fontSize: 20 * SizeConfig.widthScale),
            ),
            IconButton(
...
class TooltipShapeMatch extends ShapeBorder {
  ...
  Path getOuterPath(Rect rect, {TextDirection? textDirection}) {
    ...
    final Path path = Path()
      // Rounded rectangle
      ..addRRect(RRect.fromRectAndRadius(adjustedRect, const Radius.circular(radius)))
      // Triangle (arrow) at the top-right corner
      ..moveTo(adjustedRect.right - arrowWidth - shiftRight,
          rect.top + arrowHeight) // Left point
      ..lineTo(adjustedRect.right - shiftRight - arrowHeight / 2,
          rect.top) // Tip of arrow
      ..lineTo(adjustedRect.right - shiftRight,
          rect.top + arrowHeight) // Right point
      ..close();
